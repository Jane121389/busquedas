        ...
        else
        {
            while (numero_hash != meta)
            {
                ...
                if (ia < 4 && ja < 4 && ia >= 0 && ja >= 0)
                {
                    ...
                    matriz_aux[i][j]  =numero_aux;
                    matriz_aux[ia][ja]=0;
                    numero_hash2      =hexa_decimal(matriz_aux);
                ...
                while (busqueda_binaria_remueve(numero_hash) == true && numero_hash >= 0)
                {
...
class Pila  //Clase que simula una pila
{
    ...
    long arreglo[]=new long[10]; //arreglo de enteros
    public Pila()
    {
